...
const faqs = [
  ...
  { question: "Instrutores de voo precisam do ICAO?", answer: "Se o instrutor opera voos internacionais ou instrui em inglês, sim. Para instrução exclusivamente doméstica em português, não é obrigatório. Porém, caso queiram progredir na carreira o ICAO é um ótimo passo." },
  ...
  return (
    <ContentPageLayout slug={PAGE_SLUG} headings={headings} faqs={faqs}>
      ...
      <ul>
        ...
        <li><strong>Voos internacionais:</strong> Obrigatório — Level 4 mínimo</li>
        <li><strong>Processos seletivos:</strong> A maioria das companhias aéreas exige Level 4 ou superior como requisito para contratação, mesmo para rotas domésticas</li>
      </ul>
      ...
      <ul>
        ...
        <li><strong>Voos internacionais:</strong> Proficiência ICAO Level 4 ou superior é obrigatória desde 2008 (exigência global da ICAO)</li>
      ...
      <ul>
        ...
        <li><strong>Antes de processos seletivos:</strong> Tenha seu ICAO Level 4 ou superior antes de se candidatar a vagas em companhias aéreas</li>
        ...
        <li><strong>Upgrade de nível:</strong> Se você tem Level 4 e quer Level 5, pode refazer a prova dentro da vigência do nível 4</li>
      </ul>
      ...
      <ul>
        ...
        <li><strong>Pilotos militares:</strong> Têm regulamentação própria do Comando da Aeronáutica, mas caso desejem migrar para a aviação comercial precisam fazer a prova ICAO</li>
