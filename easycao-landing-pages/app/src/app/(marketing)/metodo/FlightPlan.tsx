...
const flightPhases: FlightPhase[] = [
  ...
  },
  {
    ...
    topics: [
      "Todos os áudios",
      "Como cotejar",
      "Como interagir com o Controle",
      "Como reportar a situação",
      "Como dizer sua intenção",
      "Tempo verbal correto",
      "Macetes da parte 2",
      "Armadilhas da parte 2",
    ],
  },
  {
    number: 4,
    ...
    topics: [
      "Áudios da parte 3",
      "Como fazer o Reported speech",
      "Todas as perguntas",
      "Estratégia para as perguntas",
      "Comparação de forma simples",
  ...
  },
  {
    ...
    lessonCount: 38,
    topics: [
      "Figuras no modelo atual da prova",
      "O passo a passo da parte 4",
      "Como descrever as figuras",
      "Como responder as perguntas da parte 4",
      "Vocabulário relacionado às figuras",
    ],
  },
  {
    number: 6,
    ...
    lessonCount: 8,
    topics: [
      "Os 19 tópicos de aviação",
      "Todas as perguntas da parte 1",
      "Estratégias de respostas eficazes",
      "Como responder as perguntas sem precisar de muito vocabulário",
  ...
  },
  {
    ...
    topics: [
      ...
      "Simulados guiados com todo o passo a passo",
      "Exercícios práticos dentro do App",
    ],
  },
  {
    number: 8,
    ...
    description: "Encontro particular de 1h comigo para ajustar a proa e garantir que você está pronto para a aprovação, após a conclusão do módulo 5 e dos exercícios do app.",
    eta: "7 dias",
    lessonCount: 1,
    topics: [
