  ...
  return (
    <div className={`flex gap-3 ${className}`}>
      <a
        ...
        className="inline-flex items-center gap-2 bg-black text-white rounded-lg px-4 py-2 text-sm font-medium hover:bg-black/80 transition-colors"
      >
          ...
          <div>
            ...
            <ul className="space-y-3 mb-6">
              {[
                ...
                "283 trilhoes+ de combinacoes de cenarios",
